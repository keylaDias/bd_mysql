...
on tb_produtos.categoria_id = categoria_id;

-- Inner Join entre Produtos e Usuarios

select * from tb_produtos inner join tb_categorias
on tb_produtos.usuario_id = usuario_id;

-- Inner Join entre Produtos, Categorias e Usuarios

select * from tb_produtos
inner join tb_categorias on tb_produtos.categoria_id = categoria_id
inner join tb_categorias on tb_produtos.usuario_id = usuario_id;
